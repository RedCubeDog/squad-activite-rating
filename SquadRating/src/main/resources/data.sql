...
values ( 'test_email1@email.com', 'firstname1', 'last_name1', 'login1', 'patronymic1', 'CANDIDATE', 'BASIC_STATE', 1),
       ...
       ( 'test_email3@email.com', 'firstname3', 'last_name3', 'login3', 'patronymic3', 'CANDIDATE', 'BASIC_STATE', 2),
       ('test_email4@email.com', 'firstname4', 'last_name4', 'login4', 'patronymic4', 'CANDIDATE', 'BASIC_STATE', 2),
       ('test_email5@email.com', 'firstname5', 'last_name5', 'login5', 'patronymic5', 'CANDIDATE', 'BASIC_STATE', 3),
       ( 'test_email6@email.com', 'firstname6', 'last_name6', 'login6', 'patronymic6', 'CANDIDATE', 'BASIC_STATE', 3);
